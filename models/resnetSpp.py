...
def resnet20(in_channel, num_features = 64, scales = [1], num_classes = 10):
...
def resnet32(in_channel, num_features = 64, scales = [1], num_classes = 10):
    embedding_net = ResNet(BasicBlock, [5, 5, 5], in_channel, scales, num_features)
    resnet = ClassificationNet(embedding_net, num_features, num_classes)
    return resnet
    
    
def resnet44(in_channel, num_features = 64, scales = [1], num_classes = 10):
    embedding_net = ResNet(BasicBlock, [7, 7, 7], in_channel, scales, num_features)
    resnet = ClassificationNet(embedding_net, num_features, num_classes)
    return resnet


def resnet56(in_channel, num_features = 64, scales = [1], num_classes = 10):
    embedding_net = ResNet(BasicBlock, [9, 9, 9], in_channel, scales, num_features)
    resnet = ClassificationNet(embedding_net, num_features, num_classes)
    return resnet


def resnet110(in_channel, num_features = 64, scales = [1], num_classes = 10):
    embedding_net = ResNet(BasicBlock, [18, 18, 18], in_channel, scales, num_features)
    resnet = ClassificationNet(embedding_net, num_features, num_classes)
    return resnet


def resnet1202(in_channel, num_features = 64, scales = [1], num_classes = 10):
